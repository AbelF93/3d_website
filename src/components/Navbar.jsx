    ...
    >
      ...
      >
        <Link
          ...
          onClick={() => {
            setActive("");
            window.scrollTo(0, 0); //*scrolls to top page.
          }}
        >
          <img src={logo} alt="logo" className="w-9 h-9 object fill-white" />
          <p
            className="text-white text-[18px] font-bold
          cursor-pointer flex"
          >
            Abel Fortunati &nbsp;
            <span className="sm:block hidden">| Graphic & Web Desiner</span>
          </p>
        </Link>
